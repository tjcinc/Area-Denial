...
class MAD_RscMapControl: RscMapControl
{
	idc = -1;
...
class RscListBoxAction : RscListBox
{
	colorPictureSelected[] = {1,1,0,1};
	colorPictureRight[] = {1,0,0,1};
	colorPictureRightSelected[] = {1,1,0,1};
	colorSelect[]= {1,1,0,1};
	
	colorSelectBackground[] = {1,0,0,0.2};
	
	
	colorSelectBackground2[] = {1,0,0,0.2};
